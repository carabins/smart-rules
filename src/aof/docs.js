...
//contracBasisDate :{name :"дата основания" , question : "Введите дату основания для закупки"},
  ...
  numberOfStudents :{name : "кол-во студентов", question : "Введите количество Обучающихся, подлежащих обучению по Программе - цифтами(прописью)"},
  ...
  contractPrice : {name :"цена контракта" , question :"Укажите цену контракта -цифтами(прописью)- руб -цифтами- коп."},
  valueAddedTax :{name : "ндс", question : "Укажите налог на добавленную стоимость ___процентов"},
  valueAddedTaxCash : {name :"ндс" , question : "Укажите цену налога на добавленную стоимость -цифтами(прописью)- руб -цифтами- коп."},
  oneStudentPrce :{name :"стоимость" , question : "Укажите стоимость обучения одного обучающегося -цифтами(прописью)- руб -цифтами- коп."},
  priceOfStage :{name : "стоимость", question :  "Укажите стоимость обучения по 1 этапу -цифтами(прописью)- руб -цифтами- коп."},
  ...
  advancePaymentCash :{name :"аванс" , question :"Укажите размер авансового платежа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  ...
  finesCash53 :{name :"штраф" , question : "Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  fines54 : {name : "штраф", question :"укажите размер штрафа в процентах"},
  finesCash54 :{name : "штраф", question : "Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  fines55 :{name : "штраф", question : "укажите размер штрафа в процентах"},
  finesCash55 :{name :"штраф" , question : "Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  fines56 : {name : "штраф", question :"укажите размер штрафа в процентах"},
  finesCash56 : {name : "штраф", question :"Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  fines57 :{name : "штраф", question : "укажите размер штрафа в процентах"},
  finesCash57 :{name : "штраф", question : "Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
  fines58 :{name : "штраф", question : "укажите размер штрафа в процентах"},
  finesCash58 :{name : "штраф", question :"Укажите размер штрафа в  рублях  -цифтами(прописью)- руб -цифтами- коп"},
}
...
export default {
  nodes: {
    ...
    vars: N.start(Object.keys(variables).map(k=>{
      let o = variables[k]
      o.value = k
      return o
    }))
